...
public class FileManager{
	...
	private void Save(){
		try{
			...
			if (html) {
				// conversion function perform here
				output_pipe.write(exportable_data);

				System.out.println("Conversion performed");	

				// dont touch this.. it will automatically trigger off html conversion function value
				html = false;		
			}else{
	...
	// Check its New File Or Old One And Then Save It markdown file
